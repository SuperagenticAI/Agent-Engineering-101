...
import { Twitter, Linkedin, Calendar, Users, Heart } from 'lucide-react';
...
const resources = [
  { icon: Users, label: 'London Agentic AI Meetup', url: LINKS.meetup, color: 'rgba(255,255,255,0.85)' },
  { icon: Calendar, label: 'Luma Calendar', url: LINKS.luma, color: 'rgba(255,255,255,0.85)' },
];
    ...
    <SlideLayout>
      ...
      <div className="relative z-10 grid grid-cols-3 gap-8 max-w-5xl w-full">
        ...
        <motion.div variants={item} className="col-span-2 glass-strong p-8">
          <h3 className="text-xl font-black text-white mb-6 font-mono tracking-wider flex items-center gap-3">
